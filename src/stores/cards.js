...
export const useCardsStore = defineStore("cardsStore", () => {
  ...
  // Función para realizar el sorteo y asignar las posiciones
  function ditchDealer(array) {
    const raffleWinner = Math.floor(Math.random() * array.length);
    const winner = (array[raffleWinner].dealer = "dealer");

    const dealer = array[raffleWinner];
    const sb = (array[(raffleWinner + 1) % array.length].dealer = "sb");
    const bb = (array[(raffleWinner + 2) % array.length].dealer = "bb");
