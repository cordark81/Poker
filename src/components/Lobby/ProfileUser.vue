...
<template>
  <div class="flex justify-center items-center border-2 border-amber-500 rounded-3xl profileUser">
    <div class="h-56 w-72 absolute flex justify-center items-center">
      <img v-if="store.user && store.user.photoURL" class="object-cover h-28 w-28 rounded-full border-2 border-black"
        :src="store.user.photoURL" alt="profile" />
      <img v-else class="object-cover h-28 w-28 rounded-full border-2 border-black"
    ...
    <div class="h-56 mx-4 w-5/6 rounded-3xl shadow-md sm:w-80 sm:mx-0">
      ...
      <div class="h-1/2 w-full rounded-3xl flex flex-col justify-around items-center">
        <div class="w-full h-1/2 flex justify-between items-center px-3 pt-2">
          <div class="flex flex-col justify-center items-center">
            <img src="../../assets/images/depositphotos_11531027-stock-illustration-poker-chip.png" alt="Chips"
              class="h-12 w-12" />
          ...
          <div class="ml-2 flex flex-col justify-center items-center">
            <button @click="logOut"
              ...
              <img src="../../assets/images/cerrar-sesion2.png" alt="Google logo" class="inline-block w-6 h-6" />
              Log out
            </button>
          </div>
        </div>
        <div v-if="store.user" class="w-full h-1/2 flex flex-col justify-center items-center">
