    ...
    <div>
        <transition enter-active-class="ease-out duration-300" enter-class="opacity-0" enter-to-class="opacity-100"
            ...
            <div class="relative z-10" aria-labelledby="modal-title" role="dialog" aria-modal="true">
                ...
                <div class="background-noAccess fixed inset-0 z-10 overflow-y-auto flex items-center justify-center">
                                ...
                                <div class="sm:flex sm:items-start">
                                    <div class="w-full text-center">
                                        <div>
                                            ...
                                            <h2 class="text-xl font-semibold mb-2 text-white">Ya estás sentado</h2>
                                            <p class="text-white">Ya estás ocupando un asiento. Por favor, levántate del
                                                asiento actual antes
                                                de seleccionar otro.</p>
