<template>
  <div class="absolute bottom-0 right-0 w-64 h-64">
    ...
    <button v-if="storePot.potMax(seats,true)!==0" class="bg-blue-500" @click="storeConsole.raiseConsole(seats,room,index)">Raise</button>
    <button v-if="storeGame.verifySimilarPots(seats)===false" class="bg-red-500" @click="storeConsole.foldConsole(seats,room,index)">Fold</button>
