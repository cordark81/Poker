    ...
    >
      <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
        ...
        <form class="space-y-4 md:space-y-6" @submit.prevent="doLogin">
          <div>
            <label for="email" class="text-white block mb-2 text-sm font-medium dark:text-white"
          ...
          <div>
            <label for="password" class="text-white block mb-2 text-sm font-medium dark:text-white"
              >Contraseña</label
            >
            <input
              v-model="password"
