...
<style scoped>
.background-login {
  background-image: url("../assets/background-login.jpg"); /* Reemplaza con la ruta correcta a tu imagen de fondo */
  background-size: cover;
  background-position: center;
  /* Agrega cualquier otra configuración de estilo que desees para el fondo */
}
</style>
