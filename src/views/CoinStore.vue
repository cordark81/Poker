...
<template>
  <div class="flex justify-center items-center h-screen coinStore">
    <form
      @submit.prevent="buyCoins"
      class="w-96 p-8 border-2 border-amber-400 bg-black rounded-lg shadow-lg"
    >
      <h1 class="text-white text-3xl font-bold mb-6">Compra de Monedas</h1>

      <div class="mb-6 flex flex-row justify-center">
        <label for="amount" class="block mb-2 mr-10 mt-2 text-lg font-medium text-white"
          >Cantidad:</label
        >
        <input
          type="number"
      ...
      <div class="mb-6">
        <label for="paymentMethod" class="block mb-2 text-lg font-medium text-white"
