<template>
	<div class="h-screen bg-green-600">
		...
		<div
			class="border border-slate-300 rounded-full h-2/4 w-2/4 flex flex-row justify-around mt-20 mx-auto"
		>
			<div class="flex flex-wrap">
				...
				>
					<div class="bg-gray-100 shadow-lg rounded-lg p-6">
						...
						<button
							v-if="seat.user && seat.user === storeUser.user.displayName"
							@click="standUpSeat(index)"
		...
		>
			<div class="bg-white p-4 rounded-lg shadow-lg">
				...
				<p>
					Ya estás ocupando un asiento. Por favor, levántate del asiento actual
					antes de seleccionar otro.
				</p>
				<button
					class="bg-gray-300 mt-4 px-4 py-2 rounded-md"
					@click="closeModal"
				>
					Cerrar
				</button>
